...
<style>
    ...
    body {
        background: url("https://www.explorerbus.com.au/images/large/about-us.html_IMAGERIGHT4.jpg") no-repeat;
...
<div class="sub-main-w3">
    <form action="/userlogin" id="demo" novalidate action="#" method="post">
        ...
        <div class="form-group-2">
            ...
            <button class="btn btn-default btn-osx btn-lg">Login</button>
        </div>
...
<form:form action="/userlogin" modelAttribute="login" >
    ...
    <div class="container">
        ...
        <form:input path="Username" type="text" placeholder="Enter Username" name="Username" required=""/>
        <br>
